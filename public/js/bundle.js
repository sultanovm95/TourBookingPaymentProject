...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // tour.coordinates
    // Add popup
...
var updateSettigs = /*#__PURE__*/function () {
  ...
  return function updateSettigs(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateSettigs = updateSettigs;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51JO9DgG6wsiCeDnnKBqMkEaJ3ecRToIV1dpfPuTXz38BosNHQGuu0X7N5hXOkXDvwcw0f6NHqpQJJKo3P8ZtODAu00sNHcQhNQ'); // 1) Get checkout session from API
...
if (updateData) {
  updateData.addEventListener('submit', function (e) {
    ...
    console.log(form);
    (0, _updateSettings.updateSettigs)(form, 'data');
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return (0, _updateSettings.updateSettigs)({
